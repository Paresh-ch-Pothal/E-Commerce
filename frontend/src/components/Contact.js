...
const Contact = () => {
    return (
        <div>
            <section className="text-gray-400 body-font relative" style={{ backgroundColor: "#101011" }}>
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                        <iframe
                            ...
                            marginWidth="0"
                            scrolling="no"
                            src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=IIIT%20Bhubaneswar%20Campus,%20Bhubaneswar,%20Odisha,%20India&ie=UTF8&t=&z=14&iwloc=B&output=embed"
                            style={{
